...
local oFaceAngleYaw, oInteractStatus, oBehParams, oBhvParams2ndByte, oPosX, oPosY, oPosZ, oHomeX, oHomeZ, oHomeY, oFaceAnglePitch, oFaceAngleRoll, oMoveAngleYaw, oStarSpawnDisFromHome, oVelocity.Y, oForwardVel, oStarSpawnUnkFC, ACTIVE_FLAG_INITIATED_TIME_STOP, oAction, oTimer, oInteractionSubtype, ACTIVE_FLAG_DEACTIVATED, oHiddenStarTriggerCounter = Constants.oFaceAngleYaw, Constants.oInteractStatus, Constants.oBehParams, Constants.oBhvParams2ndByte, Constants.oPosX, Constants.oPosY, Constants.oPosZ, Constants.oHomeX, Constants.oHomeZ, Constants.oHomeY, Constants.oFaceAnglePitch, Constants.oFaceAngleRoll, Constants.oMoveAngleYaw, Constants.oStarSpawnDisFromHome, Constants.oVelocity.Y, Constants.oForwardVel, Constants.oStarSpawnUnkFC, Constants.ACTIVE_FLAG_INITIATED_TIME_STOP, Constants.oAction, Constants.oTimer, Constants.oInteractionSubtype, Constants.ACTIVE_FLAG_DEACTIVATED, Constants.oHiddenStarTriggerCounter
...
local function bhv_collect_star_init(o)
	...
	if bit32.band(currentLevelStarFlags, bit32.lshift(1, starId)) then
...
local function bhv_star_spawn_init(o)
	...
	o.MoveAngleYaw = atan2s(o.HomeZ - o.Position.Z, o.HomeX - o.Position.X)
	o.StarSpawnDisFromHome = sqrtf((o.HomeX - o.Position.X) ^ 2 + (o.HomeZ - o.Position.Z) ^ 2)
	o.Velocity.Y = (o.HomeY - o.Position.Y) / 30.0
	...
	o.ActiveFlags:Has(ACTIVE_FLAG_INITIATED_TIME_STOP) then
